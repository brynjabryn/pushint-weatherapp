...
(function(window, document) {
  ...
  angular.module('vsGoogleAutocomplete').directive('vsGoogleAutocomplete', [
    'vsGooglePlaceUtility',
    '$timeout',
    function(vsGooglePlaceUtility, $timeout) {
      return {
        restrict: 'A',
        ...
        link: function(scope, element, attrs, ctrls) {
          ...
          var autocomplete = new google.maps.places.Autocomplete(element[0], autocompleteOptions);
